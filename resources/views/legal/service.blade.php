...
<div id="legalContainer">
    ...
    <div class="cont">
      ...
      <h1 class="legal_h1">4. Term; Termination.</h1>
          ...
          <h2>4.2 Termination by YourUnity.</h2>
              <p>
                  Except to the extent we have agreed otherwise in a separate written Addendum Agreement between you and an authorized officer of YourUnity, YourUnity may terminate your right to use the Services at any time for (a) your violation or breach of these Terms of Service; (b) your misuse or abuse of the Services; or (c) if allowing you to access and use the Services would violate any applicable local, state, provincial, national and other laws, rules and regulations or would expose YourUnity to legal liability. We will use reasonable efforts to provide you notice of any such termination. Further, you agree that YourUnity shall not be liable to you or any third-party for any such termination of your right to use or otherwise access the Services.
              </p>
      ...
      <h1 class="legal_h1">5. Important Legal Terms Governing All Use Of The Services (AKA, The Legal “Stuff”).</h1>
          ...
          <h2>5.2 Disclaimer of Warranties.</h2>
              <p>
                  YourUnity PROVIDES OUR SERVICES USING A COMMERCIALLY REASONABLE LEVEL OF SKILL AND CARE AND WE TRY TO KEEP YourUnity UP, BUG-FREE AND SAFE. BUT THERE ARE CERTAIN THINGS THAT WE DON’T PROMISE ABOUT OUR SERVICES AND YOU USE THE SERVICES AT YOUR OWN RISK. TO THE EXTENT PERMITTED BY APPLICABLE LAWS, THE SERVICES ARE PROVIDED ON AN “AS IS” AND “AS AVAILABLE” BASIS. YourUnity HEREBY EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, TITLE, NON-INFRINGEMENT AND FITNESS FOR A PARTICULAR PURPOSE. BY WAY OF EXAMPLE, YourUnity MAKES NO WARRANTY THAT (A) THE SERVICES (OR ANY PORTION OF THE SERVICES) WILL MEET YOUR REQUIREMENTS OR EXPECTATIONS; (B) THE SERVICES WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE; OR (C) THE RESULTS THAT MAY BE OBTAINED FROM THE USE OF THE SERVICES WILL BE ACCURATE OR RELIABLE. YOU ACKNOWLEDGE THAT YourUnity HAS NO CONTROL OVER AND DOES NOT GUARANTEE THE QUALITY, SAFETY OR LEGALITY OF EVENTS ADVERTISED, THE TRUTH OR ACCURACY OF ANY USERS’ (INCLUDING ATTENDEES’, OTHER NON-ORGANIZERS’ AND ORGANIZERS’) CONTENT OR LISTINGS AND YourUnity IS NOT AFFILIATED WITH, AND HAS NO AGENCY OR EMPLOYMENT RELATIONSHIP WITH, ANY THIRD PARTY SERVICE PROVIDER USED IN CONJUNCTION WITH THE SERVICES, AND YourUnity HAS NO RESPONSIBILITY FOR, AND HEREBY DISCLAIMS ALL LIABILITY ARISING FROM, THE ACTS OR OMISSIONS OF ANY SUCH THIRD PARTIES.
                  NOTHING IN THESE TERMS OF SERVICE IS INTENDED TO EXCLUDE OR LIMIT ANY CONDITION, WARRANTY, RIGHT OR LIABILITY WHICH MAY NOT BE LAWFULLY EXCLUDED OR LIMITED. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF CERTAIN WARRANTIES OR CONDITIONS OR THE LIMITATION OR EXCLUSION OF LIABILITY FOR LOSS OR DAMAGE CAUSED BY WILLFUL ACTS, NEGLIGENCE, BREACH OF CONTRACT OR BREACH OF IMPLIED TERMS, OR INCIDENTAL OR CONSEQUENTIAL DAMAGES. ACCORDINGLY, ONLY THOSE LIABILITY AND OTHER LIMITATIONS WHICH ARE LAWFUL IN YOUR JURISDICTION (IF ANY) WILL APPLY TO YOU AND OUR LIABILITY IS LIMITED TO THE MAXIMUM EXTENT PERMITTED BY LAW.
              </p>

          <h2>5.3 Limitation of Liability.</h2>
              <p>
                  TO THE EXTENT PERMITTED BY APPLICABLE LAWS, YourUnity, AND ITS AFFILIATES AND SUBSIDIARIES, AND EACH OF ITS AND THEIR RESPECTIVE OFFICERS, DIRECTORS, AGENTS, CO-BRANDERS, LICENSORS, PAYMENT PROCESSING PARTNERS, OTHER PARTNERS, EMPLOYEES AND ANY APPLICABLE CARD SCHEMES, SHALL NOT BE LIABLE UNDER ANY CIRCUMSTANCES OR UNDER ANY LEGAL THEORY, WHETHER IN TORT, CONTRACT, OR OTHERWISE, WITH RESPECT TO THE SERVICES, OR ANY OTHER SUBJECT MATTER OF THESE TERMS OF SERVICE, INCLUDING WITHOUT LIMITATION THE TERMS OF USE AND ANY OTHER PART OF THESE TERMS OF SERVICE, FOR: (A) ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE OR EXEMPLARY DAMAGES, INCLUDING, BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES (EVEN IF YourUnity HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), (B) THE COST OF PROCUREMENT OF SUBSTITUTE SERVICES, (C) ANY OF YOUR CONTENT (AS DEFINED IN THE TERMS OF USE) OR ANY CONTENT OF ANY OTHER USER OF THE SERVICES, OR (D) ANY MATTERS BEYOND YourUnity’S REASONABLE CONTROL. IN ADDITION THE MAXIMUM AGGREGATE LIABILITY OF YourUnity, LICENSORS AND ANY APPLICABLE CARD SCHEMES FOR ALL DAMAGES, LOSSES, LIABILITIES, COSTS AND EXPENSES UNDER ANY LEGAL THEORY, WHETHER IN TORT, CONTRACT, OR OTHERWISE, WITH RESPECT TO, ARISING OUT OF OR RELATED TO THE SERVICES, OR ANY OTHER SUBJECT MATTER OF THESE TERMS OF SERVICE, INCLUDING WITHOUT LIMITATION THE TERMS OF USE AND ANY OTHER PART OF THESE TERMS OF SERVICE, SHALL BE LIMITED TO ORGANIZERS OF EVENTS WITH FREE TICKETS ONLY, ATTENDEES AND OTHER USERS.

                  <br/>NOTHING IN THESE TERMS OF SERVICE IS INTENDED TO EXCLUDE OR LIMIT ANY CONDITION, WARRANTY, RIGHT OR LIABILITY WHICH MAY NOT BE LAWFULLY EXCLUDED OR LIMITED. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF CERTAIN WARRANTIES OR CONDITIONS OR THE LIMITATION OR EXCLUSION OF LIABILITY FOR LOSS OR DAMAGE CAUSED BY WILLFUL ACTS, NEGLIGENCE, BREACH OF CONTRACT OR BREACH OF IMPLIED TERMS, OR INCIDENTAL OR CONSEQUENTIAL DAMAGES. ACCORDINGLY, ONLY THOSE LIABILITY AND OTHER LIMITATIONS WHICH ARE LAWFUL IN YOUR JURISDICTION (IF ANY) WILL APPLY TO YOU AND OUR LIABILITY IS LIMITED TO THE MAXIMUM EXTENT PERMITTED BY LAW.
              </p>

          <h2>5.4 Release.</h2>
              <p>
                  As an inducement to YourUnity permitting you to access and use the Services, you hereby agree to release YourUnity, and its affiliates and subsidiaries, and each of its and their respective officers, directors, agents, partners and employees from all damages (whether direct, indirect, incidental, consequential or otherwise), losses, liabilities, costs and expenses of every kind and nature, known and unknown, arising out of or in any way connected with disputes between you and third parties (including other Users) in connection with the Services or any event listed on the Services. In addition, you waive any applicable law or statute, which says, in substance:
          ...
          <h2>5.5 Trademarks.</h2>
              <p>
                  The trademarks, service marks and logos of YourUnity (the “YourUnity Trademarks”) used and displayed in connection with the Services are registered and unregistered trademarks or service marks of YourUnity. Other company, product and service names used in connection with the Services may be trademarks or service marks owned by third parties (the “Third Party Trademarks,” and, collectively with YourUnity Trademarks, the “Trademarks”). The offering of the Services shall not be construed as granting, by implication, estoppel, or otherwise, any license or right to use any Trademark displayed in connection with the Services without the prior written consent of YourUnity specific for each such use. The Trademarks may not be used to disparage YourUnity, any third party or YourUnity’s or such third party’s products or services, or in any manner that may damage any goodwill in the Trademarks. Use of any Trademarks as part of a link to or from any site is prohibited unless YourUnity approves the establishment of such a link by prior written consent specific for each such link. All goodwill generated from the use of any YourUnity Trademark shall inure to YourUnity’s benefit.
              </p>
          ...
          <h2>5.7 Entire Agreement.</h2>
              <p>
                  These Terms of Service, including the Terms of Use and any other part of these Terms of Service, constitute the entire agreement between you and YourUnity and govern your use of the Services, superseding any prior or contemporaneous agreements, proposals, discussions or communications between you and YourUnity on the subject matter hereof, other than any written Addendum Agreement between you and an authorized officer of YourUnity relating to a specified event or events.
              </p>

          <h2>5.8 Choice of Law.</h2>
              <p>
                  Except as set forth in Section 5.9 below, these Terms of Service and the provision of the Services to you are governed by the laws of the state of California, U.S.A., without reference to principles of conflict of laws.
              </p>

          <h2>5.9 BINDING ARBITRATION.</h2>
              <p>
                  ...
                  <br/><br/>(d) Exceptions.
                  <br/>Notwithstanding this Agreement to arbitrate, either party may (i) bring an action on an individual basis in small claims court (to the extent the applicable claim qualifies), (ii) bring issues to the attention of federal, state or local agencies, including, for example, the Federal Trade Commission and the California Division of Consumer Services, which agencies may be able to seek relief on a party’s behalf (the Complaint Assistance Unit of the Division of Consumer Services may be contacted in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834, or by telephone at (800) 952-5210), and (iii) bring suit in court to seek a preliminary injunction or other interim relief pending the outcome of arbitration. In addition, the portion of any dispute or complaint relating to our participation in the US-EU or US-Swiss Safe Harbor Frameworks is subject to the Dispute Resolution section of our Privacy Policy before being subject to this Section.

                  <br/><br/>(e) No Class Actions.
                  <br/>YOU AGREE THAT YOU MAY BRING CLAIMS AGAINST YourUnity ONLY IN YOUR INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, CONSOLIDATED OR REPRESENTATIVE PROCEEDING. THE ARBITRATOR MAY NOT CONSOLIDATE MORE THAN ONE PERSON’S CLAIMS, MAY NOT PRESIDE OVER ANY FORM OF CLASS, CONSOLIDATED OR REPRESENTATIVE PROCEEDING AND MAY ONLY PROVIDE RELIEF IN FAVOR OF THE INDIVIDUAL PARTY SEEKING RELIEF AND ONLY TO THE EXTENT NECESSARY TO PROVIDE RELIEF WARRANTED BY THAT PARTY’S INDIVIDUAL CLAIM.

                  <br/><br/>(f) Notice of Dispute.
                  ...
                  <br/>ii. Just as in any court proceeding, each party will initially bear its own attorneys’ fees and expenses in connection with any arbitration. Should either party be determined to have substantially prevailed in the arbitration, then upon such party’s request, the arbitrator shall award such prevailing party the reasonable attorneys’ fees and expenses that it incurred in connection with the arbitration. The arbitrator may make rulings and resolve disputes as to the reimbursement of attorneys’ fees and expenses upon request from either party made within fourteen (14) days of the arbitrator’s ruling on the merits.

                  <br/><br/>(i) Future Changes.
                  <br/>Notwithstanding any provision in these Terms of Service to the contrary, you and YourUnity agree that if YourUnity makes any future change to this arbitration provision (other than a change to the Notice Address) YourUnity will provide you with notice of such change and you may reject any such change by sending us written notice within thirty (30) calendar days of the change to the Notice Address provided above. By rejecting any future change, you are agreeing that you will arbitrate any dispute between us in accordance with the language of this provision as unmodified by such rejected change.

                  <br/><br/>(j) Special Severability.
                  <br/>In the event that the provisions of Section 5.9(e) above are found to be invalid or unenforceable for any dispute or claim, then, notwithstanding Section 5.10, the entirety of this Section 5.9 shall be null and void with respect to such dispute or claim and Section 5.11 shall apply in lieu of this Section 5.9.

                  <br/><br/>(k) Opt Out.
                  <br/>We believe that on a whole this agreement to arbitrate will benefit our Users. There is no option to opt-out and this provision will be effective as to such new accounts upon account creation. For unregistered Attendees and other Users, this provision will apply to all future activities on the Services after September 1, 2017.

          <h2>5.10 Waiver; Invalid Provisions.</h2>
              <p>
                  The failure or delay of YourUnity to exercise or enforce any right or provision of these Terms of Service shall not constitute a waiver of such right or provision. No oral waiver, amendment or modification shall be effective under any circumstance whatsoever. If any provision of these Terms of Service is found by an arbitrator or court of competent jurisdiction to be invalid, the parties nevertheless agree that the arbitrator or court should endeavor to give effect to the parties’ intentions as reflected in the provision, and the other provisions of these Terms of Service shall remain in full force and effect.
              </p>

          <h2>5.11 Judicial Forum.</h2>
              <p>
                  In the event that the Agreement to Arbitrate above is found not to apply to you or to a particular claim or dispute, then any dispute or claim not subject to arbitration shall be resolved exclusively by a federal court located in San Diego County, California, and to the extent there is no subject matter jurisdiction in such federal court, then a state court in San Diego County, California. Both you and YourUnity agree to submit to the personal jurisdiction and venue of such courts and agree that such forum is convenient.
              </p>
          ...
          <h2>5.15 Relationship.</h2>
              <p>
                  No independent contractor, agency, partnership, joint venture, employer-employee or franchiser-franchisee relationship is intended or created by these Terms of Service, except to the extent expressly set forth in Section 4 of the Terms of Use.
              </p>
