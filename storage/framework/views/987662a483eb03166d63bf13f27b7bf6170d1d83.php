...
<form method="POST" action="/events">
    ...
    <div class="card card-inverse text-center col-centered mb-4 p-3" >
        <div class="card-block">
            ...
            <a href="/events/<?php echo e($event->id); ?>" class="float-left">Cancel</a>
    ...
    <div class="form-group invisible">
        <input type="text" class="form-control" id="duplicate_id" aria-describedby="emailHelp" value="<?php echo e($event->id); ?>" name="duplicate_id">
    </div>

    <!-- Event Name (Hidden)-->
    <div class="form-group invisible">
        <label for="event_name">Event name</label>
        <input type="text" class="form-control" id="event_name" aria-describedby="emailHelp" value="<?php echo e($event->event_name); ?>" name="event_name">
    </div>
