		...
		<div class="col-sm-12 p-4">
			...
			<div class="row p-1 mt-4">
				<div class="col-lg-6 col-md-6 col-sm-6">
					<img src="<?php echo e(url('/images/post.png')); ?>" class="screenshot tinted" alt="Create an Event">
				</div>
			...
			<div class="row p-1 mt-4">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 flex-second">
					<img src="<?php echo e(url('/images/analytics.png')); ?>" class="screenshot tinted" alt="Track Events">
				</div>
			</div>
			<div class="row p-1 mt-4">
				<div class="col-lg-6 col-md-6 col-sm-6">
		...
		<div class="col-sm-12 p-5">
			<div class="row">
				<div class="col-sm-12 center">
					...
					<a href="https://itunes.apple.com/us/app/yourunity/id1291525611?ls=1&mt=8"><img src="<?php echo e(url('/images/appstore.svg')); ?>" class="appstore" alt="Download YourUnity on the App Store"></a>
					<hr class="short" />
				</div>
			</div>
			<div class="row mt-4 p-2">
				<div class="col-sm-4 center">
					<img src="<?php echo e(url('/images/iphone_find_events.png')); ?>" class="iphone" alt="YourUnity iPhone app screenshot">
				</div>
				<div class="col-sm-4 center">
					<img src="<?php echo e(url('/images/iphone_register.png')); ?>" class="iphone" alt="YourUnity iPhone app screenshot">
				</div>
				<div class="col-sm-4 center">
					<img src="<?php echo e(url('/images/iphone_checkin.png')); ?>" class="iphone" alt="YourUnity iPhone app screenshot">
				</div>
			</div>
			<div class="row mt-4">
				<div class="col-sm-4 center">
